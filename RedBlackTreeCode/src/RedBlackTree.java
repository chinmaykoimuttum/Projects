...
public class RedBlackTree<T extends Comparable<T>> {
    ...
    private void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
      if (child.parent != parent){
        throw new IllegalArgumentException("unrelated child and parent node references");
      }
      
      Node<T> leftChildVal = parent.leftChild;
      Node<T> rightChildVal = parent.rightChild;
      Node<T> parentVal = child.parent;
      
      if (child.isLeftChild() == false) {
        
        rightChildVal = parent.rightChild;
        parent.rightChild = rightChildVal.leftChild;
        
        if(rightChildVal.leftChild!=null) {
          rightChildVal.leftChild.parent = parent;
        }
        rightChildVal.parent = parent.parent;
        if (parent.parent==null) {
          root = rightChildVal;
        }
        else if(parent == parent.parent.leftChild) {
          parent.parent.leftChild = rightChildVal;
        }
        else {
          parent.parent.rightChild = rightChildVal;
        }
        rightChildVal.leftChild = parent;
        parent.parent = rightChildVal;
      } else {
        leftChildVal = parent.leftChild;
        parent.leftChild = leftChildVal.rightChild;
        
        if(leftChildVal.rightChild!=null) {
          leftChildVal.rightChild.parent = parent;
        }
        leftChildVal.parent = parent.parent;
        if (parent.parent==null) {
          root = leftChildVal;
        }
        else if(parent == parent.parent.rightChild) {
          parent.parent.rightChild = leftChildVal;
        }
        else {
          parent.parent.leftChild = leftChildVal;
        }
        leftChildVal.rightChild = parent;
        parent.parent = leftChildVal;
    ...
    public static boolean test1() {
      ...
      if (tree.toLevelOrderString().equals("[ 30, 10, 50 ]")) {
        //System.out.println("Rotate right works");
        return true;
      }
      else {
        //System.out.println("Rotate right fails");
        return false;
      }
    }
    ...
    public static boolean test2() {
      ...
      if (tree.toLevelOrderString().equals("[ 70, 50, 80 ]")) {
        //System.out.println("Rotate left works");
        return true;
      }
      else {
        //System.out.println("Rotate left works");
    ...
    public static boolean test3() {
      ...
      if (tree.toLevelOrderString().equals("[ 60, 30, 10, 50 ]")) {
        //System.out.println("Rotate left works");
        return true;
      }
      else {
